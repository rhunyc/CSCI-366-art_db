...
$updateQuery = "delete from inventory where artwork_id = ".$artwork_id." AND size_id = '".$size_id."'";
...
echo "<table border = '1'><tr><td>Size</td><td>Name</td><td></td></tr>";
...
if (isValid($quantity)) {
	...
	{
		oci_commit($conn);
                echo "<script> location.href='inventory_delete.php';</script>"; 
        } 
	else 
	{ 
